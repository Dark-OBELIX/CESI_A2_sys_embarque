...
Liste *initListe();
void ajouterdebut(Liste *liste, int data);
void ajoutermilieu(Liste *liste, int data, int indice);
void ajouterfin(Liste *liste, int data);
...
void ajouterdebut(Liste *liste, int data) {
  ...
  Mesure *nouveaunbr = (Mesure*)malloc(sizeof(*nouveaunbr));
  nouveaunbr->nombre = data;

  /* Insertion de l'élément crée au début de la liste */
  nouveaunbr->suivant = liste->premier;
  liste->premier = nouveaunbr;
}
////////////////////////////////////////////////////////////////////////////// //////////////////////////////////////////////////////////////////////////////
void ajoutermilieu(Liste *liste, int data, int indice) {
  /* Création nouvelle element*/
  ...
  nouveaunbr->suivant = x->suivant;
  x->suivant = nouveaunbr;
}
